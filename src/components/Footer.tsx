const Footer = () => {
  return (
    <footer className="w-full bg-slate-50">
      <div className="max-w-5xl mx-auto grid grid-cols-5 gap-16 p-4 pt-16 pb-10">
        <div className="w-full col-span-2">
          ...
          <form className="flex w-full items-center mt-4">
            <div className="w-8/12">
              <input
                type="email"
                className="w-full border border-slate-300 px-4 py-2 focus:outline-0 rounded-l-2xl"
              ></input>
            </div>
